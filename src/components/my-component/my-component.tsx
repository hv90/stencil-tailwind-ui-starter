...
export class MyComponent {
  ...
  private handleClickOutside = (event: MouseEvent): void => {
    const menu = document.querySelector('my-component * #menu');
    const target = event.target as HTMLElement;

    if (menu && !menu.contains(target) && 'toggleMenu' !== target.id) {
      if (this.isOpen) {
        this.toggleMenu();
      }
    }
  ...
  render() {
    return (
      <div>
        ...
        --> */}
                <div
                  ...
                  class={
                    ...
                    `${this.isOpen ? 'transition ease-out duration-200 opacity-100 translate-y-0' : 'h-0 transition ease-in duration-150 opacity-0 translate-y-1'}`
                  }
                >
                  <div class="p-4">
              ...
              <div class="mt-6 flow-root">
                ...
                --> */}
                      ...
                      <div class="mt-2 space-y-2" id="disclosure-1">
                        <a href="#" class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                          Analytics
                        </a>
                        <a href="#" class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                          Engagement
        ...
        <div id="initial-component">Hello, World! I'm {this.getText()}</div>
      </div>
    );
  }
}
